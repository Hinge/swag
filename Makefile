...
BINARY_NAME:=swag
PACKAGES:=$(shell $(GOLIST) github.com/Hinge/swag github.com/Hinge/swag/cmd/swag github.com/Hinge/swag/gen github.com/Hinge/swag/format)
